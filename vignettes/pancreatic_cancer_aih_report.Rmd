...
# Check the directory where the file 'aih_analysis.RData' is saved and adjust the path accordingly.
```

# 1. Introduction 

This report presents the results of the analysis of the count of patients treated with surgery for pancreatic cancer, based on data provided by DATASUS and using the methodology proposed by Ziegelmann et all (paper in *peer review*) and implemented by the `OncoDatasusR` package. The R code used to generate the results presented here is available in the package documentation (see vignette "pancreatic_cancer_aih_example").
...
For more details about the methodology for patient counting and the selection of the key variable, see the vignette "pancreatic_cancer_aih_example".
