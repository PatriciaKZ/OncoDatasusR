...
load("../data/exported_data/apac_pancreas_analysis.RData")
...
```
The number of APACs of selected procedures was **`r table_procedures$after[1] `**

The table below presents the number of procedures performed in the APACs by ICD code, considering all selected procedures performed in the period of analysis.
...
The Number of unique CNS codes identified among the **`r table_procedures$after[1]`** selected APACs was **`r n_before_deduplication`**.
